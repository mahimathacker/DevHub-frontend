                ...
                <div className="space-y-8 text-black/70 dark:text-[#22c55e]/70 font-mono">
                    ...
                    <section className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="flex items-start gap-2 text-sm sm:text-base">
                                <span>🔹</span>
                                While we strive to ensure accuracy, we do not guarantee that all information is always up to date or correct.
                            </p>
                            <p className="flex items-start gap-2 text-sm sm:text-base">
                                <span>🔹</span>
                    ...
                    <section className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <p className="flex items-start gap-2 text-sm sm:text-base">
                                <span>✅</span>
                                Respect others—no hate speech, spam, or abusive behavior.
                            </p>
                            <p className="flex items-start gap-2 text-sm sm:text-base">
                                <span>✅</span>
                            ...
                            <p className="flex items-start gap-2 text-sm sm:text-base">
                                <span>✅</span>
                                Follow applicable laws when posting or interacting on the platform.
                            </p>
                        </div>
                        <p className="flex items-start gap-2 text-sm sm:text-base mt-4">
                            <span>🚫</span>
                            Misuse of the platform (such as scams, misleading info, phishing, or harmful behavior)
                    ...
                    <section className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="flex items-start gap-2 text-sm sm:text-base">
                                <span>🔹</span>
                                Do not copy or republish content without proper attribution.
                            </p>
                        </div>
                    </section>
